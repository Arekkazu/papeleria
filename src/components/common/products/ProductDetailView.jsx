...
export const ProductDetailView = ({ producto }) => {
  ...
  const handleAdd = async () => {
    ...
    try {
      ...
      setMsg(
        `Se agregaron ${cantidad} unidad${cantidad > 1 ? "es" : ""} de "${producto.name}" al carrito.`,
      );
      setOpen(true);
    } catch (error) {
    ...
    >
      ...
      >
        ...
        >
          ...
          <Typography
            variant="body1"
            sx={{ mb: 2, color: "text.secondary", fontSize: 18 }}
          >
            {producto.description ||
              "Este es un excelente producto de papelería ideal para tus necesidades escolares, de oficina o personales."}
          </Typography>
          <Box
            sx={{
              width: "100%",
          ...
          >
            ...
            >
              ...
              >
                Precio:{" "}
                <span style={{ color: "#2697a6" }}>
                  <b>${producto.price.toLocaleString()}</b>
                </span>
              </Typography>
              <Box
                sx={{
              ...
              <Button
                variant="outlined"
                fullWidth
                sx={{ mb: 1, fontWeight: 700, py: 1.2, fontSize: 16 }}
                onClick={handleAdd}
              >
                Agregar al carrito
              </Button>
